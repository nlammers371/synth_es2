...
CompPath <- 'C:/Users/Nicholas/Documents/GitHub/ES2_sequences/beforeAlignment/'
WritePath <- './intermediate/'

DepEs2 <- readDNAStringSet("./intermediate/dmel_es2.fa") #minimal Dmel ES2 from Depace Paper

LudEs2 <- readDNAStringSet(paste0(CompPath,'ludwig_eve-striped-2.fa')) #set of comparison sequences from ludwig 2011
