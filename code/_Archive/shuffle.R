...
#derives from my decision to take 6bp the basic structural unit for es2 
bound = 12
base = 6
...
write.table(insertions, file = paste0(WritePath,"/csv/es2_shuff_variant_insertions.csv"),row.names=FALSE, na="",col.names=TRUE, sep=",")
